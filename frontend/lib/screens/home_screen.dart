...
class _HomeScreenState extends State<HomeScreen> {
    ...
    try {
      ...
      setState(() {
        ...
        for (var event in events) {
          // Backend now returns formatted string: "2026-01-04 20:48:00"
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('My Calendar'), elevation: 0),
      drawer: Drawer(
        child: ListView(
            ...
            child: _selectedEvents.isEmpty
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Parse datetime - backend sends: "2026-01-04 20:48:00"
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          final result = await Navigator.pushNamed(
            context,
            '/add_event',
            arguments: {'token': widget.token, 'selectedDate': _selectedDay},
          );
          if (result == true) {
            _fetchEvents();
          }
